     ...
     <section class="mb-20 ">
        ...
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3 xl:gap-x-12 ">
          <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div class="p-6">
                    <h5
                    class="font-Flipahaus mb-2 text-2xl leading-tight text-green-bauzan text-left font-semibold">
                    Desarrollo y Diseño de Sitios Web Estáticos - Bajo Costo
                    </h5><br></br>
                    <p class="text-base text-green-bauzan ">
                    ¿Deseas fortalecer la presencia digital de tu negocio? ¿Estás listo para proyectar una imagen más profesional? No te dejes engañar por plataformas como Wix. 
                    </p><br></br>
                    <p class="text-base text-green-bauzan ">
                    En nuestro servicio, diseñamos, alojamos y proporcionamos un dominio para tu proyecto digital estático a un costo accesible, con un diseño adaptado a tus necesidades y la tecnología de seguridad más avanzada.
                    </p>
                </div>
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-xl text-red-900  line-through">Desde $11,000 mxn</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-green-bauzan ">Desde $6,999 mxn</span>
                    </li>
                </ul>
                    <div class="p-6">
                    <Link to={'/contact'}>
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-xl font-bold text-red-900  line-through">Desde $4,000 mxn</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-black-900 ">Desde $2,499 mxn</span>
                    </li>
                </ul>
                    <div class="p-6">
                    <Link to={'/contact'}>
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-xl font-bold text-red-900  line-through">Desde $300 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-black-900 ">Desde $220 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                </ul>
                    <div class="p-6">
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-red-900  line-through">Desde $400 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-3xl font-bold text-black-900 ">Desde $299 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                </ul>
                    <div class="p-6">
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-red-900  line-through">Desde $1100 mxn</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-3xl font-bold text-black-900 ">Desde $699 mxn</span>
                    </li>
                </ul>
                    <div class="p-6">
                    <Link to={'/contact'}>
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-red-900  line-through">Desde $12 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-3xl font-bold text-black-900 ">Desde $5 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                </ul>
                    <div class="p-6">
             ...
             <div class="block max-w-[22rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <ul class="w-full">
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-2xl font-bold text-red-900  line-through">Desde $30 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                    <li
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50">
                    <span class="text-3xl font-bold text-black-900 ">Desde $19 mxn</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                    </li>
                </ul>
                    <div class="p-6">
