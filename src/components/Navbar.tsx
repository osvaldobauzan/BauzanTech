  ...
  return (
    <Navbar fluid rounded className="md:flex md:justify-center xl:h-20 lg:h-16 ">    
      ...
      <Navbar.Collapse>
        ...
        <Link to={'/contact'}>
        <Navbar.Link href="#"  className="flex font-bold items-center px-4 mb-1 xl:text-xl hover:text-green-bauzan hover:border-b-2-green-bauzan transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-300">Contactanos</Navbar.Link>
        </Link>
      </Navbar.Collapse>
    </Navbar>
