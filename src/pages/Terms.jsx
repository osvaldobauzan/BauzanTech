  ...
  return (
    <section className="font-Montserrat text-left font-semibold lg:text-lg">
      ...
      <p class="mx-20 mt-10 mb-2 text-gray-500 dark:text-gray-400 xl:mb-10">
        Al acceder y utilizar nuestros servicios, aceptas los siguientes
        términos y condiciones:<br></br>
        <br></br> Uso del Servicio: Nuestros servicios están destinados
        únicamente para uso personal o comercial. No se permite el uso indebido
        del servicio con fines ilegales o no autorizados.<br></br>
        <br></br> Pago y Facturación: Los precios de nuestros servicios están
        ...
        <br></br>
        <br></br>Cancelación y Reembolso: Cualquier cancelación de servicio debe
        ...
        servicio. <br></br>
        <br></br>Privacidad y Seguridad: Respetamos tu privacidad y protegemos
        ...
        transmitida a través de Internet.<br></br>
        <br></br> Propiedad Intelectual: Todos los derechos de propiedad
        intelectual relacionados con nuestros servicios son propiedad de nuestra
        empresa. No se permite la reproducción, distribución o modificación de
        nuestros servicios sin nuestro consentimiento previo por escrito.{" "}
        <br></br>
        <br></br>Limitación de Responsabilidad: No nos hacemos responsables de
        ningún daño directo, indirecto, incidental, especial o consecuente que
        pueda surgir del uso de nuestros servicios.
        <br></br>
        <br></br>Modificaciones: Nos reservamos el derecho de modificar estos
        términos y condiciones en cualquier momento sin previo aviso. Se te
        notificará cualquier cambio a través de nuestro sitio web. <br></br>
        <br></br>Al utilizar nuestros servicios, aceptas estos términos y
        condiciones en su totalidad. Si no estás de acuerdo con alguno de estos
        términos, te rogamos que no utilices nuestros servicios. Para más
        detalles sobre nuestros términos y condiciones, por favor contáctanos.
      </p>
      ...
      <p class="mx-20 mt-10 mb-2 text-gray-500 dark:text-gray-400 xl:mb-10">
        ...
        personalizado. <br></br>
        <br></br>Al utilizar nuestro sitio web, aceptas el uso de cookies de
        acuerdo con esta política. Puedes controlar y gestionar el uso de
        ...
        de usuario. <br></br>
        <br></br>Utilizamos diferentes tipos de cookies, incluyendo cookies
        ...
        marketing. <br></br>
        <br></br>Si deseas obtener más información sobre cómo utilizamos las
