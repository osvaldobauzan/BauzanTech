...
export const Testimonials = () => {
  ...
  return (
    ...
    <>
    <section>
      <h1 className="mx-20 mt-10 font-Flipahaus text-6xl font-bold leadi sm:text-6xl text-green-bauzan">Nuestros Clientes</h1> 

      <p className="mx-20 mt-10 mb-2 text-gray-500 dark:text-gray-400 xl:mb-10">
        ¿Todavía tienes algunas dudas? ¡Entendemos! Echa un vistazo a algunos de nuestros clientes y descubre cómo los hemos ayudado a iniciar
      y hacer crecer sus negocios. Estamos orgullosos de haber colaborado con empresas de diversos sectores
        y tamaños, brindándoles soluciones digitales personalizadas que han impulsado su éxito en el mundo digital. </p>

        <p className="mx-20 mt-4 mb-12 text-gray-500 dark:text-gray-400">
          ¡Inspírate con nuestros casos de éxito y únete a la lista de empresarios que 
        han confiado en nosotros para llevar sus negocios al siguiente nivel!</p>


<div className='flex justify-center'>
<div className="h-56 sm:h-64 xl:h-80 2xl:h-96 max-w-5xl w-full bg-green-bauzan rounded-xl m-5 md:m-0 shadow-2xl">
  <Carousel indicators={false}>
    <figure className="max-w-screen-md mx-auto text-center">
      ...
      <blockquote>
        ...
        "¡Estoy encantado con el servicio que recibí de BauzanTech! No solo entregaron mi sitio web antes de lo esperado, sino que también superaron mis expectativas en términos de diseño y funcionalidad."
        </p>
      </blockquote>
      <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
        ...
        <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
          ...
          <cite className="ps-3 text-sm lg:text-base text-white">Estaca La Libertad</cite>
          </a>
        </div>
      </figcaption>
    </figure>
